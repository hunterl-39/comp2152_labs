...
def fib(n):
    ...
    return fib(n - 1) + fib(n - 2)  # Remove this line when you add your code
...
def binary_search_recursive(nums, target, left, right):
    ...
    # Hint: return binary_search_recursive(nums, target, mid + 1, right)
        ...
        return binary_search_recursive(nums, target, mid + 1, right) # Remove this line when you add your code
